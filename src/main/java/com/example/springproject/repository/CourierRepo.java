...
public class CourierRepo implements AbstractRepo<Courier>{
    ...
    public CourierRepo() throws CantCreateCourierException {
        ...
        this.create(new Courier(UUID.fromString("88eef4a2-5ff2-4bcf-baa9-9376ff8e26e5"),"Kurier Lodz",51.769352, 19.488426, UUID.fromString("26699969-efc3-4099-9742-3c863be4a984")));
    }
