...
public class CourierRepo implements AbstractRepo<Courier>{
    ...
    public CourierRepo() throws CantCreateCourierException {
        ...
        this.create(new Courier(UUID.fromString("88eef4a2-3ca5-4bcf-b569-6f2ec20f483c"),"Kurier 1",0,0,UUID.fromString("26699969-59b4-42f1-8c70-6d403a522767")));
        this.create(new Courier(UUID.fromString("1b12b987-b96a-4c17-9428-9376ff8e26e5"),"Kurier 2",16,0,UUID.fromString("4c6d7ecc-efc3-44ce-95e8-44182f86362b")));
        this.create(new Courier(UUID.fromString("b442336c-5ff2-4ef3-baa9-50b66820de43"),"Kurier 3",-9,0,UUID.fromString("f13f7383-1b75-439a-b44f-589f94f4a5e0")));
        this.create(new Courier(UUID.fromString("88eef4a2-5ff2-4bcf-baa9-9376ff8e26e5"),"Kurier Lodz",51.74742630835883, 19.453865227380266, UUID.fromString("26699969-efc3-4099-9742-3c863be4a984")));
    }
